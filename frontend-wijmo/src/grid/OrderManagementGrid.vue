<template>
    <div style="max-height:80vh;">
        ...
        <OrderManagmentQuery @search="search"></OrderManagmentQuery>
        ...
        >
            ...
            <wj-flex-grid-column binding="index" header="번호" width="2*" :isReadOnly="true" align="center" />
            <wj-flex-grid-column binding="accountingYearAndMonth" header="회계년월" width="2*" :isReadOnly="true" align="center" />
            <wj-flex-grid-column binding="orderType" header="수주유형" width="2*" :isReadOnly="true" align="center" />
            <wj-flex-grid-column binding="orderNumber" header="수주번호" width="2*" :isReadOnly="true" align="center" />
            <wj-flex-grid-column binding="placeOfDelivery" header="납품처" width="2*" :isReadOnly="true" align="center" />
            <wj-flex-grid-column binding="fewWeeks" header="수주일" width="2*" :isReadOnly="true" align="center" />
            <wj-flex-grid-column binding="dueDate" header="납기일" width="2*" :isReadOnly="true" align="center" />
            <wj-flex-grid-column binding="numberOfOrderItems" header="수주항목수" width="2*" :isReadOnly="true" align="center" />
            <wj-flex-grid-column binding="totalDrinkingCapacity" header="총 수주량" width="2*" :isReadOnly="true" align="center" />
            <wj-flex-grid-column binding="totalOrderAmount" header="총 수주금액" width="2*" :isReadOnly="true" align="center" />
            ...
            >
                ...
                <v-card>
                    <v-toolbar
                        ...
                        height="50px"
                    >
                        <div style="color:white; font-size:17px; font-weight:700;">수주관리 등록</div>
                        <v-spacer></v-spacer>
                        <v-icon
                            color="white"
                            small
                    ...
                    <v-card-text>
                    <div>
                        <OrderManagement :offline="offline"
                            :isNew="!selectedItem"
                            :editMode="true"
                            v-model="orderManagementModel"
                            @add="append"
                        />
                    </div>
                    </v-card-text>
        ...
        async deleteSelectedRows() {
            try {
                if (!this.offline) {
                    ...
                    if (view.currentItem) {
                        const deleteUrl = view.currentItem._links.orderManagement.href;
