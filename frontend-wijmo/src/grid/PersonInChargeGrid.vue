            ...
            >
                ...
                <v-card>
                    <v-toolbar
                        ...
                        height="50px"
                    >
                        <div style="color:white; font-size:17px; font-weight:700;">담당자 등록</div>
                        <v-spacer></v-spacer>
                        <v-icon
                            color="white"
                            small
                    ...
                    <v-card-text>
                    <div>
                        <PersonInCharge :offline="offline"
                            :isNew="!selectedItem"
                            :editMode="true"
                            v-model="personInChargeModel"
                            @add="append"
                        />
                    </div>
                    </v-card-text>
...
export default {
    name : 'personInCharge-grid',
    mixins:[PersonInCharge],
    components:{
        PersonInCharge,
    },
    data: () => ({
        ...
        async deleteSelectedRows() {
            try {
                if (!this.offline) {
                    ...
                    if (view.currentItem) {
                        const deleteUrl = view.currentItem._links.personInCharge.href;
