                ...
                <v-list-item v-for="(data, n) in values" :key="n">
                    ...
                    <v-list-item-content>
                        ...
                        <v-list-item-subtitle style="font-size:25px; font-weight:700;">
                            [ Id :  {{data.id }} ] &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            [ AccountingYearAndMonth :  {{data.accountingYearAndMonth }} ] &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            [ OrderType :  {{data.orderType }} ] &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            [ OrderNumber :  {{data.orderNumber }} ] &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            [ PlaceOfDelivery :  {{data.placeOfDelivery }} ] &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            [ FewWeeks :  {{data.fewWeeks }} ] &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            [ DueDate :  {{data.dueDate }} ] &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            [ NumberOfOrderItems :  {{data.numberOfOrderItems }} ] &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            [ TotalDrinkingCapacity :  {{data.totalDrinkingCapacity }} ] &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
