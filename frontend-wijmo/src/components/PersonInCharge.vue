...
export default {
    ...
    created(){
        ...
        websocketUrl.pathname = "/rsocket/personInCharges";
        websocketUrl.hash = "";
        ...
        client.connect().subscribe({
            ...
            const endpoint = "personInCharges."+ me.value.id +".get"
    ...
    methods: {
        ...
        async save(){
            try {
                ...
                if(!this.offline) {
                    if(this.isNew) {
                        temp = await axios.post(axios.fixUrl('/personInCharges'), this.value)
                    } else {
